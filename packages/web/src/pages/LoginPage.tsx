  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-900">Portfolio Tracker</h2>
          <p className="mt-2 text-sm text-gray-600">
            Track your investments and manage your portfolio allocation
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">Secure authentication powered by AWS Cognito</p>
        </div>
      </div>
    </div>
  );
